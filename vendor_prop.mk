PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    qemu.hw.mainkeys=0 \
    ril.read.imsi=1 \
    ro.build.display.id=K6306W3BL.HDJ.P0.ANASAPA9DATJDF.0718_1849.V5.10 \
    ...
    ro.com.google.clientidbase.ms=android-blu-rev2 \
    ro.com.google.clientidbase=android-blu \
    ro.config.alarm_alert=Alarm_Clock2.mp3 \
    ro.config.notification2_sound=BLU_Message3.mp3 \
    ro.config.notification_sound=BLU_Message3.mp3 \
    ro.config.ringtone2=BLU_Ringtone4.mp3 \
    ...
    ro.pcba_oversea_customer=none \
    ro.pri.ai.scene=1 \
    ro.pri.ai.scene_title=1 \
    ro.pri.arcsoftpicselfie.seekbar=1 \
    ro.pri.back.default.videosize=6 \
    ro.pri.bangs.screen=0 \
    ro.pri.brand.watermark=1 \
    ro.pri.brandwatermark.default.value=off \
    ro.pri.charging_sound=0 \
    ro.pri.current.project=6 \
    ro.pri.faceid=1 \
    ro.pri.false.focus=1 \
    ro.pri.fingerprint=gf5118m_tee \
    ro.pri.flash.front=1 \
    ro.pri.front.default.videosize=6 \
    ro.pri.front.mirror=1 \
    ro.pri.fullscreen.support=1 \
    ro.pri.light.style=light \
    ro.pri.mode.aperture=1 \
    ro.pri.mode.nightcam=1 \
    ...
    ro.pri_battery_capacity=3950 \
    ro.pri_bg_power_saving_enable=1 \
    ro.pri_bluetooth=0 \
    ro.pri_board_network_type=LfB/WB/GB \
    ...
    ro.pri_dtmf_tone_when_dialing=0 \
    ...
    ro.pri_launcher_singleanddouble=0 \
    ro.pri_launcher_translucent=1 \
    ro.pri_led_switch_support=0 \
    ro.pri_lockscreen_sounds=0 \
    ...
    ro.pri_splitscreen=255 \
    ro.pri_stream_accessibility=5 \
    ro.pri_stream_alarm=5 \
    ro.pri_stream_bluetooth_sco=5 \
    ro.pri_stream_dtmf=5 \
    ro.pri_stream_music=5 \
    ro.pri_stream_notification=5 \
    ro.pri_stream_ring=5 \
    ro.pri_stream_system=5 \
    ro.pri_stream_system_enforced=5 \
    ro.pri_stream_tts=5 \
    ro.pri_stream_voice_call=5 \
    ro.pri_tee=2 \
    ro.pri_time_12_24=12 \
    ro.pri_touch_sounds=0 \
    ro.pri_use_camera_low_battery=0 \
    ro.pri_vibrate_on_touch=1 \
    ro.pri_vibrate_when_ringing=0 \
    ro.pri_wifi=1 \
    ro.pri_wireless_charger=1 \
    ...
    ro.vendor.mediatek.version.release=alps-mp-p0.mp1-V5.97 \
